...
export default class Main extends Component {
  render() {
    const img = (<video className="columns__video" preload="auto" autoPlay={true} loop="true" muted="muted"><source src={homeColumnVideo} type="video/mp4"/></video>);
    const header = (<>
    <h1 className="columns__headline">Introducing Your New Workout Wardrobe</h1>
    ...
    return (
      <main className="main">
        ...
        <div className="follow"><HeadlineUpperCase text="Follow us on Instagram" /></div>
        </section>
      </main>
    );
  }
